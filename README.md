...
python -m pytest -v
python -m src.main
python -m PyInstaller --onefile --windowed --name "ComparadorExcel" --icon="images/pine_logo.ico" --add-data "images/pine_logo.ico;images" --add-data ".venv\Lib\site-packages\emoji_data_python\data;emoji_data_python\data" src/main.py
```
